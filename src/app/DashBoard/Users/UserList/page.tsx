          ...
          <table className="min-w-full table-auto">
            <thead className="bg-blue-600 text-white">
              <tr className="">
                ...
                <th className="py-8 px-6 text-left">Email</th>
                <th className="py-8 px-6 text-left">Role</th>
                <th className="py-8 px-6 text-left">Status</th>

                <th className="py-8 px-6 text-center">Actions</th>
              </tr>
            </thead>
            <tbody>
              {user.map((user) => (
                <tr key={user.id} className="border-t hover:bg-gray-200">
                  ...
                  <td className="px-4 py-4 flex justify-evenly">
                    <button className="px-4 py-2 text-gray-700 rounded-lg bg-gray-100 hover: bg-gray-200 transition-colors">
                      Edit{" "}
                    </button>
                    <button className="ml-2 px-4 py-2 text-white bg-blue-600 rounded-lg hover:bg-blue-800 transition-colors">
                      View{" "}
                    </button>
                  </td>
                </tr>
